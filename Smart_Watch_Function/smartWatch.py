...
def smartWatch(status, BLoodPressure, HeartRate):
    ...
    if status == "sleeping":
        ...
        if HR_Flag == True and BP_Flag == True:
            print("BLood Pressure and Heart Rate Problem While Fainting")
            print("System Activated")
            print("Calling 911")
            HR_Flag == False
            BP_Flag == False
        elif HR_Flag == True and BP_Flag == False:
            print("Heart Rate Problem While Fainting")
            print("System Activated")
            print("Calling 911")
            HR_Flag == False
        elif HR_Flag == False and BP_Flag == True:
...
print("------ at Blood Pressure = 140/90 and Heart Rate = 110 and Status is \"Sleeping\" ------")
smartWatch("sleeping", "120/80", 110)
print("-" * 80)
